...
## Server Status
Online:[For user that use AptvPlayer for play the stream, please use another player like vlc/tivimate and etc.., this due the app just constanly request the stream to every channel to get the thumbnail wichs make the server go a litle bit traffic spike and trigger the firewall.]
